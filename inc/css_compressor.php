...
function long_colours_to_short_hex(&$string)
{
   ...
   $colours = array(array('000000', 'black'), array('ff00ff', 'fuchsia'), array('ffff00', 'yellow'), array('ffffff', 'white'));
...
function combine_props_list(&$props)
{
   ...
   combine_props_borders($props, 'border', array('border-bottom', 'border-top', 'border-left', 'border-right'));
   combine_props($props, 'border', array('border-width', 'border-style', 'border-color'));
