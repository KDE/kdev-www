...
#-------------------------------------------------------
# $Revision: 1.15 $ - $Author: aclu $ - $Date: 2008/04/23 15:08:27 $
...
# begin harcoded the revision because our CVS and the developers (http://cvschangelogb.sourceforge.net/) has different revisions (Amilcar Lucas)
$REVISION='1.83';
# end harcoded the revision because our CVS and the developers (http://cvschangelogb.sourceforge.net/) has different revisions (Amilcar Lucas)
